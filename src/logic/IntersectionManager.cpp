            ...
            switch(this->intersection_count) {
                ...
                case 1: {
                    ...
                    if (this->side == DOOR_SIDE) {
                        ...
                        this->tape_sensor->update();
                        // wait till side qrds are on T to stop reverse 
                        while(!this->tape_sensor->qrd7.is_on()&&!this->tape_sensor->qrd6.is_on()&&(millis()-t_timeout<2000)) {
                            this->tape_sensor->update();
                        }
                        // delay(240);
                        this->drive_system->update(0.93, -2.8);
                        this->drive_system->actuate();
                        delay(280);
                        ...
                        // wait till side qrds are on T to stop reverse 
                        while(!this->tape_sensor->qrd1.is_on()&&!this->tape_sensor->qrd0.is_on()&&(millis()-t_timeout<2000)) {
                            this->tape_sensor->update();
                        }
                    ...
                    if (this->side == DOOR_SIDE) {
                        ...
                        this->drive_system->update(0.93, -3.1);
                        this->drive_system->actuate();
                ...
                case 2: {
                    ...
                    if (this->side) {
                        this->drive_system->update(0.84, 0.93);
                    }
                    else {
                        this->drive_system->update(0.93, 0.84);
                    }
